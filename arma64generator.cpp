...
A64::Register Generator::Context::GetFree () const
{
...
A64::Register Generator::Context::Select (const Code::Operand& operand) const
{
	assert (IsRegister (operand)); return Translate (registers[operand.register_], operand.type);
}

A64::Immediate Generator::Context::Extract (const Code::Operand& operand) const
{
	assert (IsImmediate (operand)); return Immediate (Code::Convert (operand));
}

Generator::Context::SmartOperand Generator::Context::Acquire (const Code::Type& type)
{
	return {*this, GetFree (), type};
}

Generator::Context::SmartOperand Generator::Context::Acquire (const Code::Operand& operand)
{
	if (IsRegister (operand)) return Select (operand); return Acquire (operand.type);
}

Generator::Context::SmartOperand Generator::Context::Load (const Code::Operand& operand)
{
...
Generator::Context::SmartOperand Generator::Context::Load (const Immediate immediate, const Code::Type& type)
{
...
Generator::Context::SmartOperand Generator::Context::Load (const Code::Section::Name& address,
                                                           const Code::Displacement displacement)
{
...
void Generator::Context::Store (const Operand& register_, const Code::Operand& operand)
{
	switch (operand.model)
	{
	case Code::Operand::Register:
...
void Generator::Context::Access (const Instruction::Mnemonic mnemonic, const Operand& register_, const Code::Operand& operand)
{
...
void Generator::Context::Emit (const Instruction::Mnemonic mnemonic, const Code::Section::Name& address)
{
	Emit ({mnemonic, Immediate {0}}, address, 0, 0);
	if (listing) WriteAddress (listing << '\t' << mnemonic << '\t', nullptr, address, 0, 0) << '\n';
}

void Generator::Context::Emit (const Instruction::Mnemonic mnemonic, const Operand& operand1, const Code::Section::Name& address, const Code::Displacement displacement)
{
...
void Generator::Context::Emit (const Instruction::Mnemonic mnemonic, const Operand& operand1, const Code::Section::Name& address, const Code::Displacement displacement, const Object::Patch::Scale scale, const Operand& operand2)
{
...
void Generator::Context::Emit (const Instruction& instruction, const Code::Section::Name& address, const Code::Displacement displacement, const Object::Patch::Scale scale)
{
...
void Generator::Context::Displace (const Operand& register_, const Immediate immediate)
{
	if (!immediate) return;
...
void Generator::Context::Move (const Operand& target, const Operand& source)
{
...
void Generator::Context::Extend (const Operand& register_, const Code::Type& type)
{
...
void Generator::Context::Load (const Operand& register_, Immediate immediate, const Code::Type& type)
{
...
void Generator::Context::Load (const Operand& register_, const Code::Section::Name& address, const Code::Displacement displacement)
{
...
void Generator::Context::Acquire (const Code::Register register_, const Types&)
{
...
void Generator::Context::Move (const Code::Operand& target, const Code::Operand& source)
{
	if (IsRegister (target)) Load (Select (target), source);
	else Store (Load (source), target);
}

void Generator::Context::Convert (const Code::Operand& target, const Code::Operand& source)
{
...
void Generator::Context::Operation (const Instruction::Mnemonic mnemonic, const Code::Operand& target, const Code::Operand& value)
{
	const auto result = Acquire (target); Emit ({mnemonic, result, Load (value)}); Store (result, target);
}

void Generator::Context::Operation (const Instruction::Mnemonic mnemonic, const Code::Operand& target, const Code::Operand& value1, const Code::Operand& value2)
{
...
void Generator::Context::Pop (const Code::Operand& target)
{
	const auto result = Acquire (target); Emit ({GetLoadMnemonic (target.type), result, {SP, 0}, Immediate {16}}); Store (result, target);
}

void Generator::Context::Compare (const Code::Operand& value1, const Code::Operand& value2)
{
...
void Generator::Context::Branch (const Instruction::Mnemonic mnemonic, const Code::Operand& target)
{
...
std::ostream& Generator::Context::WriteRegister (std::ostream& stream, const Code::Operand& operand, const Part)
{
	return stream << Translate (registers[operand.register_], operand.type);
}

bool Generator::Context::IsValidUnsigned (const Immediate immediate)
{
...
A64::Register Generator::Context::Translate (const Operand& register_, const Code::Type& type)
{
	return Translate (TranslateBack (GetRegister (register_)), type);
}

A64::Register Generator::Context::Translate (const Register register_, const Code::Type& type)
{
...
A64::Register Generator::Context::TranslateBack (const Register register_)
{
	return Register (X0 + register_ % 32);
}

A64::Instruction::Mnemonic Generator::Context::GetLoadMnemonic (const Code::Type& type)
{
...
A64::Instruction::Mnemonic Generator::Context::GetStoreMnemonic (const Code::Type& type)
{
