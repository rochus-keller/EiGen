...
Checker::Context::Context (const Checker& c, Object::Section& s, const Origin o, const InstructionAlignment ia, const SectionAlignment sa, const Inlined i) :
    charset(c.charset), instructionAlignment(ia), sectionAlignment(sa), inlined(i),
    diagnostics(c.diagnostics), section(s), origin(o)
{
