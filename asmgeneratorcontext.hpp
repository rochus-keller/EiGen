...
namespace Assembly {
    ...
    public:
        ...
        const Generator& getGenerator() const { return generator; }
    protected:
        class Label;
        class LocalLabel;
    ...
    class Generator::Context::LocalLabel : public Label
    {
    public:
        ~LocalLabel ();
    ...
    struct Generator::Context::LocalDefinition
    {
        Code::Size limit;
        LocalLabel label;
        Code::Operand value;
    ...
    struct Generator::Context::InstructionFixup
    {
        Code::Size offset;
        Code::Size index;
        FixupCode code;
    ...
    struct Generator::Context::TypeDeclaration
    {
        Code::Size extent;
        Debugging::Type* type;
