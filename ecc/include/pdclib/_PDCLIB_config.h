...
// see https://stackoverflow.com/questions/44896370/how-are-the-gnu-c-preprocessor-predefined-macros-used

/* int_fast8_t / uint_fast8_t                                                 */
#define _PDCLIB_int_fast8_t        char
#define _PDCLIB_INT_FAST8_MAX      __SCHAR_MAX__
#define _PDCLIB_INT_FAST8_MIN      _PDCLIB_MIN_CALC( __INT_FAST8_MAX__ )
#define _PDCLIB_uint_fast8_t       unsigned char
#define _PDCLIB_UINT_FAST8_MAX     255

/* int_least8_t / uint_least8_t                                               */
#define _PDCLIB_int_least8_t       char
#define _PDCLIB_INT_LEAST8_MAX     __SCHAR_MAX__
#define _PDCLIB_INT_LEAST8_MIN     _PDCLIB_MIN_CALC( __INT_LEAST8_MAX__ )
#define _PDCLIB_uint_least8_t      unsigned char
#define _PDCLIB_UINT_LEAST8_MAX    255

/* int_fast16_t / uint_fast16_t                                               */
#define _PDCLIB_int_fast16_t       short
#define _PDCLIB_INT_FAST16_MAX     __SHRT_MAX__
#define _PDCLIB_INT_FAST16_MIN     _PDCLIB_MIN_CALC( __INT_FAST16_MAX__ )
#define _PDCLIB_uint_fast16_t      unsigned short
#define _PDCLIB_UINT_FAST16_MAX    (__SHRT_MAX__ << 1)

/* int_least16_t / uint_least16_t                                             */
#define _PDCLIB_int_least16_t      short
#define _PDCLIB_INT_LEAST16_MAX    __SHRT_MAX__
#define _PDCLIB_INT_LEAST16_MIN    _PDCLIB_MIN_CALC( __INT_LEAST16_MAX__ )
#define _PDCLIB_uint_least16_t     unsigned short
#define _PDCLIB_UINT_LEAST16_MAX   (__SHRT_MAX__ << 1)

/* int_fast32_t / uint_fast32_t                                               */
#define _PDCLIB_int_fast32_t       int
#define _PDCLIB_INT_FAST32_MAX     __INT_MAX__
#define _PDCLIB_INT_FAST32_MIN     _PDCLIB_MIN_CALC( 2147483647 )
#define _PDCLIB_uint_fast32_t      unsigned int
#define _PDCLIB_UINT_FAST32_MAX    (__INT_MAX__ << 1)

/* int_least32_t / uint_least32_t                                             */
#define _PDCLIB_int_least32_t      int
#define _PDCLIB_INT_LEAST32_MAX    __INT_MAX__
#define _PDCLIB_INT_LEAST32_MIN    _PDCLIB_MIN_CALC( __INT_LEAST32_MAX__ )
#define _PDCLIB_uint_least32_t     unsigned int
#define _PDCLIB_UINT_LEAST32_MAX   (__INT_MAX__ << 1)

/* int_fast64_t / uint_fast64_t                                               */
#define _PDCLIB_int_fast64_t       long long 
#define _PDCLIB_INT_FAST64_MAX     __LONG_LONG_MAX__
#define _PDCLIB_INT_FAST64_MIN     _PDCLIB_MIN_CALC( __INT_FAST64_MAX__ )
#define _PDCLIB_uint_fast64_t      unsigned long long
#define _PDCLIB_UINT_FAST64_MAX    (__LONG_LONG_MAX__ << 1)

/* int_least64_t / uint_least64_t                                             */
#define _PDCLIB_int_least64_t      long long
#define _PDCLIB_INT_LEAST64_MAX    __LONG_LONG_MAX__
#define _PDCLIB_INT_LEAST64_MIN    _PDCLIB_MIN_CALC( __INT_LEAST64_MAX__ )
#define _PDCLIB_uint_least64_t     unsigned long long
#define _PDCLIB_UINT_LEAST64_MAX   (__LONG_LONG_MAX__ << 1)
...
#define _PDCLIB_int64_t  long long
#define _PDCLIB_uint8_t  unsigned char
#define _PDCLIB_uint16_t unsigned short
#define _PDCLIB_uint32_t unsigned int
...
#define _PDCLIB_intmax_t     long long
#define _PDCLIB_INTMAX_MAX   __LONG_LONG_MAX__
#define _PDCLIB_INTMAX_MIN   _PDCLIB_MIN_CALC( __INTMAX_MAX__ )
#define _PDCLIB_INTMAX_C      c ## LL
#define _PDCLIB_uintmax_t    unsigned long long
#define _PDCLIB_UINTMAX_MAX  (__LONG_LONG_MAX__ << 1)
#define _PDCLIB_UINTMAX_C    c ## ULL
...
#define _PDCLIB_FLT_EVAL_METHOD   2

#define _PDCLIB_FLT_HAS_SUBNORM   1
#define _PDCLIB_DBL_HAS_SUBNORM   __DBL_HAS_DENORM__
#define _PDCLIB_LDBL_HAS_SUBNORM  __LDBL_HAS_DENORM__

#define _PDCLIB_FLT_RADIX         2

#define _PDCLIB_FLT_MANT_DIG      24
#define _PDCLIB_DBL_MANT_DIG      53
#define _PDCLIB_LDBL_MANT_DIG     64

#define _PDCLIB_FLT_DECIMAL_DIG   9
...
#define _PDCLIB_FLT_DIG           6
#define _PDCLIB_DBL_DIG           15
#define _PDCLIB_LDBL_DIG          __LDBL_DIG__

#define _PDCLIB_FLT_MIN_EXP       (-125)
#define _PDCLIB_DBL_MIN_EXP       (-1021)
#define _PDCLIB_LDBL_MIN_EXP      __LDBL_MIN_EXP__

#define _PDCLIB_FLT_MIN_10_EXP    (-37)
#define _PDCLIB_DBL_MIN_10_EXP    (-307)
#define _PDCLIB_LDBL_MIN_10_EXP   __LDBL_MIN_10_EXP__

#define _PDCLIB_FLT_MAX_EXP       128
#define _PDCLIB_DBL_MAX_EXP       1024
#define _PDCLIB_LDBL_MAX_EXP      16384

#define _PDCLIB_FLT_MAX_10_EXP    38
#define _PDCLIB_DBL_MAX_10_EXP    308
#define _PDCLIB_LDBL_MAX_10_EXP   __LDBL_MAX_10_EXP__

#define _PDCLIB_FLT_MAX           3.40282346638528859812e+38F
#define _PDCLIB_DBL_MAX           ((double)1.79769313486231570815e+308L)
#define _PDCLIB_LDBL_MAX          __LDBL_MAX__

#define _PDCLIB_FLT_EPSILON       1.19209289550781250000e-7F
#define _PDCLIB_DBL_EPSILON       ((double)2.22044604925031308085e-16L)
#define _PDCLIB_LDBL_EPSILON      __LDBL_EPSILON__

#define _PDCLIB_FLT_MIN           1.17549435082228750797e-38F
#define _PDCLIB_DBL_MIN           ((double)2.22507385850720138309e-308L)
#define _PDCLIB_LDBL_MIN          __LDBL_MIN__

#define _PDCLIB_FLT_TRUE_MIN      1.40129846432481707092e-45F
#define _PDCLIB_DBL_TRUE_MIN      ((double)4.94065645841246544177e-324L)
