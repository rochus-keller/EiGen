...
namespace ECS
{
    ...
    template <typename Stream, typename Value>
    inline Stream& BasicIndenter<Stream, Value>::Increase (Stream& stream)
    {
        return ++indentation, stream;
    }

    template <typename Stream, typename Value>
    inline Stream& BasicIndenter<Stream, Value>::Decrease (Stream& stream)
    {
        return --indentation, stream;
    }

    template <typename Stream, typename Value>
    Stream& BasicIndenter<Stream, Value>::Indent (Stream& stream) const
    {
